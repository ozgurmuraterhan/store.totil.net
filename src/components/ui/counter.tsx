...
const variantClasses = {
  ...
  neon: "w-full h-7 md:h-9 bg-primary text-white rounded",
  argon:
  ...
  big: "w-full h-14 rounded text-white bg-primary inline-flex justify-between",
};
  ...
  return (
    ...
    >
      <button
        onClick={onDecrement}
        className={cn(
          "cursor-pointer p-2 transition-colors duration-200 focus:outline-none hover:bg-primary-2",
          {
